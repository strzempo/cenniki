...
//menu zbiorowy[0][0]
    ...
    temp.push_back("Podrêcznik kszta³tek");
    temp.push_back("Podrêcznik zaworów");
...
//produkty menu zbiorowy [0][1]
	temp.clear();
    temp.push_back("Zawory z napêdami");
    temp.push_back("Zawory rêczne z PVC-U");
...
//menu broszury [0][2]
    ...
    temp.push_back("MK/CP - Zawory membranowe pneumatyczne z napêdem t³okowym");
...
//################################
    ...
    temp.push_back("Zawory bezpieczeñstwa");
...
//zawory kulowe
	temp.clear();
    temp.push_back("VKD/CE - Zawór kulowy Dual Block \xAE DN 10-50 z si³ownikiem elektrycznym");
    temp.push_back("VKD/CE - Zawór kulowy Dual Block \xAE DN 65-100 z si³ownikiem elektrycznym");
    temp.push_back("TKD/CE - Trójdro¿ny zawór kulowy Dual Block \xAE z si³ownikiem elektrycznym");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
//zawory motylkowe
	temp.clear();
...
//pneumatyczne costam zbiorowy
    ...
    temp.push_back("Zawory skoœne");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
//kulowe
	temp.clear();
    temp.push_back("VKD/CE - Zawór kulowy Dual Block \xAE DN 10-50 z si³ownikiem pneumstycznym");
    temp.push_back("VKD/CE - Zawór kulowy Dual Block \xAE DN 65-100 z si³ownikiem pneumstycznym");
    temp.push_back("TKD/CE - Trójdro¿ny zawór kulowy Dual Block \xAE z si³ownikiem pneumstycznym");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
//motylkowe
	temp.clear();
...
//diacoœtam
	temp.clear();
    temp.push_back("VM/CP-NC - Zawór membranowy pneumatyczny normalnie zamkniêty");
    temp.push_back("VM/CP-NO - Zawór membranowy pneumatyczny normalnie otwarty");
    temp.push_back("MK/CP-NC - Zawór membranowy pneumatyczny normalnie zamkniety z si³ownikiem t³okowym");
    temp.push_back("MK/CP-NO - Zawór membranowy pneumatyczny normalnie otwarty z si³ownikiem t³okowym");
    temp.push_back("MK/CP-DA - Zawór membranowy pneumatyczny obustronego dzia³ania z si³ownikiem t³okowym");
    temp.push_back("DM/CP-NO - Zawór membranowy pneumatyczny normalnie otwarty bezsprê¿ynowy");
    temp.push_back("CM/CP - Zawór membranowy pneumatyczny - kompaktowy");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
//k¹towy 
	temp.clear();
    temp.push_back("VV/CP - zawory skoœne pneumatyczne");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
//relief zbiorowy
	temp.clear();
    temp.push_back("SV - Zawór skoœny upustowy");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
...
//kulowe
    ...
    temp.push_back("TKD PVC-U - Trójdro¿ne zawory kulowe Dual Block\xAE");
...
//Pozosta³e
    ...
    temp.push_back("VV PVC-U - Zawory skoœne");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
	div.push_back(zbiorowy);
	zbiorowy.clear();
...
//kulowe
    ...
    temp.push_back("TKD PP-H - Trójdro¿ne zawory kulowe Dual Block\xAE");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
//przepustnice
	temp.clear();
...
//bezp
	temp.clear();
    temp.push_back("VR PP-H - Zawór bezpieczeñstwa");
    temp.push_back("SR PP-H - Kulowy zawór bezpieczeñstwa");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
//filtr
	temp.clear();
...
//rury
    ...
    temp.push_back("Kszta³tki przejœciowe");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
//kulowe
	temp.clear();
    ...
    temp.push_back("TKD PVC-C - Trójdro¿ne zawory kulowe Dual Block\xAE");
...
//kulowe
    ...
    temp.push_back("TKD PVDF - Trójdro¿ne zawory kulowe Dual Block\xAE");
    temp.push_back("Powrót");
	zbiorowy.push_back(temp);
//przepustnice
	temp.clear();
